...
//        ArrayList에 추가(mStudentList.add)
        ...
        mStudentList.add(StudentData("김민철2",1992,"서울시 서대문구"))
        mStudentList.add(StudentData("김민철3",1991,"서울시 서대문구"))
        mStudentList.add(StudentData("김민철4",1980,"서울시 서대문구"))
        mStudentList.add(StudentData("김민철5",1970,"서울시 서대문구"))
        mStudentList.add(StudentData("김민철6",2000,"서울시 서대문구"))
        mStudentList.add(StudentData("김민철7",1960,"서울시 서대문구"))
        mStudentList.add(StudentData("김민철8",1950,"서울시 서대문구"))
        mStudentList.add(StudentData("김민철9",1995,"서울시 서대문구"))
        mStudentList.add(StudentData("김민철10",2003,"서울시 서대문구"))
